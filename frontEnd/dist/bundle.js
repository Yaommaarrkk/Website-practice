  ...
  (() => {
    ...
    function setAttribute2(name16) {
      return function(value17) {
        return function(element3) {
          return function() {
            element3.setAttribute(name16, value17);
          };
        };
      };
    }
      ...
      return function(tag) {
        return function(value17) {
          if (tagOf(value17) === tag) {
            return pure16(unsafeFromForeign(value17));
          }
          ;
          if (otherwise) {
    ...
    var evalQ = function(render6) {
      return function(ref2) {
        return function(q2) {
          return bind12(liftEffect4(read(ref2)))(function(v) {
            return evalM(render6)(ref2)(v["component"]["eval"](new Query(map15(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
          });
        };
      };
    };
              ...
              return function(childrenInRef) {
                return function(childrenOutRef) {
                  return unComponentSlot(function(slot5) {
                    return function __do2() {
                      var childrenIn = map17(slot5.pop)(read(childrenInRef))();
                      var $$var2 = function() {
    ...
    var string = /* @__PURE__ */ function() {
      return new $$String2(identity8);
    }();
    var ignore = /* @__PURE__ */ function() {
      return new Ignore(identity8);
    }();
    var blob = /* @__PURE__ */ function() {
      return new Blob3(identity8);
    }();
    ...
    var unsafeReadProp = function(dictMonad) {
      ...
      return function(k) {
        return function(value17) {
          return unsafeReadPropImpl(fail3(new TypeMismatch("object", typeOf(value17))), pure16, k, value17);
        };
      };
    };
    ...
    var Submit = /* @__PURE__ */ function() {
      function Submit6(value0, value1) {
        this.value0 = value0;
        this.value1 = value1;
      }
      ;
      Submit6.create = function(value0) {
        return function(value1) {
          return new Submit6(value0, value1);
        };
      };
      return Submit6;
    }();
    ...
    var ClickButton = /* @__PURE__ */ function() {
      ...
      ;
      ClickButton5.value = new ClickButton5();
      return ClickButton5;
    }();
    var render = function(state3) {
      return div_([input2([value14(state3.input), onValueInput(function(s) {
    ...
    var handleAction = function(dictMonadAff) {
      ...
      return function(action2) {
        ...
        if (action2 instanceof ClickButton) {
          return bind5(get3)(function(old_st) {
            return bind5(liftAff2(request3({
              content: defaultRequest.content,
              username: defaultRequest.username,
              password: defaultRequest.password,
              withCredentials: defaultRequest.withCredentials,
              timeout: defaultRequest.timeout,
              url: "http://127.0.0.1:10037/api/echo/" + (show4(old_st.multiple) + ("/" + old_st.input)),
              method: new Left(GET2.value),
              responseFormat: string,
              headers: [new RequestHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8")]
            })))(function(m_respond) {
              return bind5(get3)(function(st) {
                if (m_respond instanceof Right) {
                  return discard5(modify_3(function(st1) {
                    var $28 = {};
                    for (var $29 in st1) {
                    ...
                    return raise(new Submit(st.multiple, m_respond.value0.body));
                  });
                }
                ;
                if (m_respond instanceof Left) {
                  ...
                  return discard5(modify_3(function(st1) {
                    ...
                    return raise(new Submit(st.multiple, message2));
                  });
                }
                ;
                throw new Error("Failed pattern match at Widget.DoubleInput (line 89, column 5 - line 96, column 45): " + [m_respond.constructor.name]);
              });
            });
          });
        }
        ;
        throw new Error("Failed pattern match at Widget.DoubleInput (line 67, column 23 - line 96, column 45): " + [action2.constructor.name]);
      };
    };
    ...
    var stripQuotes = function(s) {
      ...
      ;
      if (v instanceof Just) {
        var $28 = length8(s) >= 2 && (eq3(charAt3(0)(v.value0))(new Just('"')) && eq3(charAt3(length8(s) - 1 | 0)(v.value0))(new Just('"')));
        if ($28) {
          return drop4(1)(take3(length8(s) - 1 | 0)(s));
        }
        ;
        return s;
      }
      ;
      throw new Error("Failed pattern match at MyLibrary.Http.Response (line 67, column 3 - line 72, column 15): " + [v.constructor.name]);
    };
    var parseConDisRH = function(headers) {
      var m_conDis = map25(function(v) {
        return v.value1;
      })(find2(function(v) {
    ...
    var parseConDis = function(conDisStr) {
      var conDisStrArr = map111(trim)(split(";")(conDisStr));
      var params = map111(map111(trim))(map111(split("="))(conDisStrArr));
      var parseCreationDate = function() {
        ...
        if (v instanceof Just) {
          return map25(stripQuotes)(index2(v.value0)(1));
        }
        ;
        return Nothing.value;
      }();
      var parseDispositionType = function() {
        ...
        if (v instanceof Nothing) {
          ...
          ;
          throw new Error("Failed pattern match at MyLibrary.Http.Response (line 90, column 20 - line 92, column 29): " + [v1.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at MyLibrary.Http.Response (line 88, column 7 - line 92, column 29): " + [v.constructor.name]);
      }();
      var parseFileName = function() {
        ...
        if (v instanceof Just) {
          var encoded = function() {
            ...
            ;
            throw new Error("Failed pattern match at MyLibrary.Http.Response (line 99, column 23 - line 101, column 28): " + [v12.constructor.name]);
          }();
        ...
        if (v instanceof Nothing) {
          ...
          if (v1 instanceof Just) {
            ...
            ;
            throw new Error("Failed pattern match at MyLibrary.Http.Response (line 105, column 25 - line 107, column 33): " + [v2.constructor.name]);
          }
          ;
          if (v1 instanceof Nothing) {
            return Nothing.value;
          ...
          ;
          throw new Error("Failed pattern match at MyLibrary.Http.Response (line 104, column 11 - line 108, column 31): " + [v1.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at MyLibrary.Http.Response (line 96, column 7 - line 108, column 31): " + [v.constructor.name]);
      }();
      ...
      var parseSize = function() {
        ...
        if (v instanceof Just) {
          ...
          ;
          throw new Error("Failed pattern match at MyLibrary.Http.Response (line 132, column 21 - line 134, column 29): " + [v1.constructor.name]);
        }
        ;
        return Nothing.value;
      }();
    ...
    function size4(blob2) {
      return blob2.size;
    }
    var type_18 = function(blob2) {
    ...
    var show12 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(showMediaType));
    ...
    var Submit2 = /* @__PURE__ */ function() {
      function Submit6(value0) {
        this.value0 = value0;
      }
      ;
      Submit6.create = function(value0) {
        return new Submit6(value0);
      };
      return Submit6;
    }();
    ...
    var downloadFile = function(blob2) {
      return function(filename) {
        return discard12(liftEffect7(function __do2() {
          log2("Blob size: " + show5(size4(blob2)))();
          return log2("Blob type: " + show12(type_18(blob2)))();
        }))(function() {
          return bind6(liftEffect7(createObjectURL(blob2)))(function(url2) {
            return discard12(liftEffect7(log2("Blob URL: " + url2)))(function() {
              return bind6(liftEffect7(windowImpl))(function(win) {
                return bind6(liftEffect7(document(win)))(function(htmlDoc) {
                  return bind6(liftEffect7(createElement2("a")(toDocument(htmlDoc))))(function(ele) {
                    ...
                    if (v instanceof Just) {
                      return liftEffect7(function __do2() {
                        ...
                        ;
                        throw new Error("Failed pattern match at Widget.DownloadFile (line 146, column 7 - line 156, column 40): " + [m_body.constructor.name]);
                      });
                    }
                    ;
                    throw new Error("Failed pattern match at Widget.DownloadFile (line 135, column 3 - line 156, column 40): " + [v.constructor.name]);
                  });
                });
              });
            });
    ...
    var handleAction2 = function(dictMonadAff) {
      ...
      return function(action2) {
        ...
        if (action2 instanceof ClickButton2) {
          return bind22(get4)(function(old_st) {
            return bind22(liftAff2(request3({
              ...
              if (m_response instanceof Right) {
                ...
                return bind22(liftAff2(downloadFile(m_response.value0.body)(fileName)))(function() {
                  return discard32(modify_4(function(st) {
                    ...
                    return bind22(get4)(function(st) {
                      return raise(new Submit2(st.message));
                    });
                  });
                });
              }
              ...
              ;
              throw new Error("Failed pattern match at Widget.DownloadFile (line 94, column 5 - line 111, column 35): " + [m_response.constructor.name]);
            });
          });
        }
        ;
        throw new Error("Failed pattern match at Widget.DownloadFile (line 76, column 23 - line 111, column 35): " + [action2.constructor.name]);
      };
    };
    ...
    var handleAction3 = function(dictMonadAff) {
      ...
      return function(action2) {
            ...
            return discard7(function() {
              if (m_respond instanceof Right) {
                return modify_5(function(st) {
                  ...
                  ;
                  $19.message = m_respond.value0.body;
                  return $19;
                });
              }
              ;
              if (m_respond instanceof Left) {
                return modify_5(function(st) {
                  ...
                  ;
                  $23.message = "error: " + printError(m_respond.value0);
                  return $23;
                });
              }
              ;
              throw new Error("Failed pattern match at Widget.FetchDevice (line 127, column 5 - line 133, column 80): " + [m_respond.constructor.name]);
            }())(function() {
              return bind7(get5)(function(st) {
        ...
        ;
        throw new Error("Failed pattern match at Widget.FetchDevice (line 91, column 23 - line 136, column 32): " + [action2.constructor.name]);
      };
    };
    ...
    var handleAction4 = function(dictMonadAff) {
      ...
      return function(action2) {
        ...
        if (action2 instanceof ClickButton4) {
          return bind8(get6)(function(old_st) {
            return bind8(liftAff2(request3({
              content: defaultRequest.content,
              username: defaultRequest.username,
              password: defaultRequest.password,
              withCredentials: defaultRequest.withCredentials,
              ...
              if (m_respond instanceof Right) {
                var m_fileName = map26(function(v) {
                  return v.value1;
                })(find2(function(v) {
                  return v.value0 === "Content-Disposition";
                ...
                return discard8(modify_6(function(st) {
                  ...
                  return bind8(get6)(function(st) {
                    return raise(new Submit5(st.fileName, st.fileContent));
                  });
                });
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at Widget.VileFile (line 81, column 5 - line 92, column 32): " + [m_respond.constructor.name]);
            });
          });
        }
        ;
        throw new Error("Failed pattern match at Widget.VileFile (line 60, column 23 - line 92, column 32): " + [action2.constructor.name]);
      };
    };
    ...
    var makeDiv = function(strs) {
      ...
      return div_(map27(makeDiv_)(strs));
    };
    var initialState = {
      message: "--",
      childInfo: "--",
      ...
      return function(v) {
        if (v instanceof FetchDevice) {
          return modify_7(function(st) {
            ...
            ;
            $41.message = v.value1.value0;
            $41.childInfo = "FetchDevice - " + show6(v.value0);
            return $41;
          });
        }
        ;
        if (v instanceof DoubleInput) {
          return modify_7(function(st) {
            ...
            ;
            $48.message = v.value1.value1;
            $48.childInfo = "DoubleInput(" + (show13(v.value1.value0) + (" times) - slotID: " + show13(v.value0)));
            return $48;
          });
        }
        ;
        if (v instanceof ViewFile) {
          if (v.value0 instanceof Submit5) {
            return modify_7(function(st) {
              ...
              ;
              $56.fileName = v.value0.value0;
              $56.fileContent = splitText(v.value0.value1);
              return $56;
            });
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Main (line 141, column 5 - line 145, column 68): " + [v.value0.constructor.name]);
        }
        ;
        if (v instanceof DownloadFile) {
          ...
          if (v.value0 instanceof $$Error) {
            return modify_7(function(st) {
              ...
              $71.childInfo = "DownloadFile";
              return $71;
            });
          }
          ;
          throw new Error("Failed pattern match at Main (line 148, column 5 - line 152, column 77): " + [v.value0.constructor.name]);
        }
        ;
        if (v instanceof UploadFile) {
          ...
          if (v.value0 instanceof $$Error2) {
            return modify_7(function(st) {
              ...
              ;
              $81.message = v.value0.value0;
              $81.childInfo = "UploadFile";
              return $81;
            });
          }
          ;
          throw new Error("Failed pattern match at Main (line 155, column 5 - line 159, column 75): " + [v.value0.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Main (line 129, column 16 - line 159, column 75): " + [v.constructor.name]);
      };
    };
